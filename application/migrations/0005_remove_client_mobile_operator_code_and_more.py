...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('application', '0004_alter_client_phone_number'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='message',
            name='client_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='application.client'),
        ),
    ]
